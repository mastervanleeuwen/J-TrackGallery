...
?>
	<div>
		<br>
		<div id="geo-msg"></div>
		<form action="<?php echo Uri::getInstance(); ?>" method="post"
	...
	<div class="<?php echo $this->toptracks; ?>_entry">
		<ul class="entry">
			...
			else
			{
				...
				{
					$link = Route::_('index.php?option=com_jtg&view=track&id=' . $new->id);
					?>
			<li>
				<div class="list-left">
	...
	<div class="<?php echo $this->toptracks; ?>_entry">
		<ul class="entry">
			...
			else
			{
				...
				{
					$link = Route::_('index.php?option=com_jtg&view=track&id=' . $hits->id);
					?>
			<li>
				<div class="list-left">
	...
	<div class="<?php echo $this->toptracks; ?>_entry">
		<ul class="entry">
			...
			else
			{
				...
				{
					$link = Route::_('index.php?option=com_jtg&view=track&id=' . $best->id);
					?>
			<li>
				<div class="list-left">
	...
	<div class="<?php echo $this->toptracks; ?>_entry">
		<ul class="entry">
			...
			else
			{
				...
				{
					$link = Route::_('index.php?option=com_jtg&view=track&id=' . $rand->id);
					?>
			<li>
				<div class="list-left">
