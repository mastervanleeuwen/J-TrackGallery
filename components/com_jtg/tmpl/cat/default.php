...
<?php if ($this->prev_cat_title) :
	...
	$ariaLabel = Text::_('JPREVIOUS') . ': ' . $this->prev_cat_title;
?>
<div style="float:left">
	<a class="page-link hasTooltip" href="<?php echo Route::_('index.php?option=com_jtg&view=cat&id='.$this->prev_cat_id); ?>" title="<?php echo $this->prev_cat_title; ?>" data-bs-original-title="<?php echo $ariaLabel; ?>" rel="prev">
...
<?php if ($this->next_cat_title) :
	...
	$ariaLabel = Text::_('JNEXT') . ': ' . $this->next_cat_title;
?>
<div style="float:right">
	<a class="page-link hasTooltip" href="<?php echo Route::_('index.php?option=com_jtg&view=cat&id='.$this->next_cat_id); ?>" title="<?php echo $this->next_cat_title; ?>" data-bs-original-title="<?php echo $ariaLabel; ?>" rel="next">
