...
<form name="adminForm" id="adminForm" method="post"
	action="<?php echo Route::_("index.php?option=com_jtg&controller=track&task=download"); ?>">
...
$this->tagLayout = new FileLayout('joomla.content.tags');
	...
	switch ($this->cfg->gallery)
	{
		case 'jd2' :
            ...
            case 'ext_plugin':
               ...
               echo HTMLHelper::_('content.prepare', $external_gallery);
               break;
