...
';
	...
	echo Bootstrap::startTabSet('tabs', $options);
	echo Bootstrap::addTab('tabs', 'mainconfig', Text::_('COM_JTG_MAINCONF'));
	?>
	...
	&nbsp;
	<?php
	echo Bootstrap::endTab();
	// Configuration END

	// Level BEGIN
	echo Bootstrap::addTab('tabs', 'levelconfig', Text::_('COM_JTG_LEVEL'));
	?>
	<table class="admintable">
		<tbody>
			<tr>
	...
	echo Bootstrap::endTab();
	// Level END
	echo Bootstrap::addTab('tabs', 'maps', Text::_('COM_JTG_MAPS'));
	...
	echo Bootstrap::addTab('tabs', 'display', Text::_('COM_JTG_DISPLAY'));
	...
	echo Bootstrap::addTab('tabs', 'comments', Text::_('COM_JTG_COMMENTS'));
	?>
	<table class="admintable">
		<tr>
			<td valign="top">
	...
	{
		echo Bootstrap::addTab('tabs', 'jtg-approach', Text::_('COM_JTG_APPROACH'));
		?>
	<table class="admintable">
		<?php
