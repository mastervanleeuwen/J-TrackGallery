...
INSERT IGNORE INTO `#__jtg_files` (`id`, `uid`, `catid`, `title`, `file`, `terrain`, `description`, `published`, `date`, `hits`, `checked_out`, `start_n`, `start_e`, `icon_n`, `icon_e`, `distance`, `ele_asc`, `ele_desc`, `level`, `access`, `istrack`, `iswp`, `isroute`, `iscache`, `vote`, `hidden`) VALUES
...
(5, 430, '15', '-sample- Via Alpina: Alzarej', 'sample_via_alpina_alzarej.gpx', '2', '', 1, '2013-10-02', 23, 0, '46.412453', '13.846174', '46.412453', '13.846174', 14.18, 1441, 1304, 1, 0, 1, 0, 0, 0, 0.000, 0),
